class Dropdown {
  ...
  getDropdownMode(e) {
    ...
    if (e.target.classList.contains('option') && e.target.parentElement.id == this.dropdownId + 'Opt') {
      return 'select';
    }
    if (e.target.classList.contains('preset') && e.target.parentElement.parentElement.id == this.dropdownId + 'Opt') {
      return 'select';
    }
